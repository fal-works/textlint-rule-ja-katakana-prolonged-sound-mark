...
const dict: DictSource = {
  ...
  requireNoMark: [
    ...
    "オーソリティ",     // authority (-ty)
    "ベロシティ",       // velocity (-ty)
    { word: "アクティビティ", derived: ["リアクティビティ"] }, // activity (-ty)
    "エンティティ",     // entity (-ty)
    "ユーティリティ",   // utility (-ty)
    "ファシリティ",     // facility (-ty)
    "パリティ",         // parity (-ty)
    ...
    { word: "ユーザビリティ", derived: ["リユーザビリティ"] },    // usability (-bility)
    { word: "ポータビリティ", derived: ["サポータビリティ"] },    // portability (-bility)
    ...
    { word: "ミュータビリティ", derived: ["イミュータビリティ"] }, // mutability (-bility)
    ...
    { word: "オペラビリティ", derived: ["インターオペラビリティ"] }, // operability (-bility)
